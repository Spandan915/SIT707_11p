...
public class OnTrackTests {
	...
	// Tutoring Sessions Test Cases
		...
		public void testScheduleSession() throws Exception {
			...
			Date sessionDate = sdf.parse("2025-05-23");

			Session session = tutoringService.scheduleSession("tutor1", "student1", sessionDate, "13:00 PM");
		...
		public void testCreateStudyGroup() {
			StudyGroup group = studyGroupService.createStudyGroup("Business Study Group", "student1");
			assertNotNull(group);
			assertEquals("Business Study Group", group.getGroupName());
