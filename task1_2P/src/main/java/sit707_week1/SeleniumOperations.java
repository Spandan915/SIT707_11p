...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
        // A. Modify the Hello message with your student ID and full name.
        System.out.println("Hello from <224047344>, <Spandan Das>");

        // B. Set up ChromeDriver path.
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Spandan\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");

        // C. Open the Chromium browser.
        System.out.println("Fire up Chrome browser.");
        WebDriver driver = new ChromeDriver();

        // D. Load Google homepage.
        driver.get("https://www.google.com");
        System.out.println("Google homepage loaded.");

        // E. Resize the window to 640x480 and sleep for 2 seconds.
        driver.manage().window().setSize(new Dimension(640, 480));
        System.out.println("Window resized to 640x480.");
        sleep(2);

        // F. Double the window size to 1280x960 and sleep for 2 seconds.
